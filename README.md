...
## Requirements
- requires  **php** *7.2*  - **php** *7.4* 
- [![Build Status](https://travis-ci.com/RapidAgileSoftware/wp-demo-plugin.svg?branch=master)](https://travis-ci.com/RapidAgileSoftware/wp-demo-plugin)
- composer 
